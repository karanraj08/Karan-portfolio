...
const socials = [
  { icon: Github, label: "GitHub", href: "https://github.com/karanraj08" },
  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/karan-raj-110994310/" },
  { icon: Mail, label: "Email", href: "mailto:karanraj43214@gmail.com" },
];
...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = `mailto:karanraj43214@gmail.com?subject=Portfolio Contact from ${form.name}&body=${form.message}%0A%0AFrom: ${form.email}`;
  };
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto flex-col-reverse md:flex-row">
          ...
          >
            <div className="glass-card glow-hover p-8 text-center flex flex-col items-center">
              ...
              <a 
                href="https://docs.google.com/document/d/1eIm-7s3cVChisBA0vCSGx2L6fHT35oP8/edit?usp=sharing&ouid=102416508001699096533&rtpof=true&sd=true" 
                target="_blank" 
